...
/**
 * {@link ExpressionLangaugeEL3Impl}のテスタ
 *
 * @since 1.6
 * @author T.TSUCHIE
 *
 */
public class ExpressionLangaugeEL3ImplTest {
    
    private ExpressionLangaugeEL3Impl el;
    
    @Before
    public void setUp() throws Exception {
        this.el = new ExpressionLangaugeEL3Impl();
    }
    ...
    public void testEvaluate_function() throws Exception {
        ...
        Taglib taglib = loader.load(ExpressionLangaugeEL3ImplTest.class.getResourceAsStream("/com/gh/mygreen/xlsmapper/expression/xlsmapper.tld"));
        el.register(taglib);
