...
/**
 * Loads annotation informations as {@link com.gh.mygreen.xlsmapper.xml.XMLInfo} 
 * from the XML file.
 * 
...
public class XMLLoader {
	...
	public static XMLInfo load(InputStream in) throws XmlLoadException {
		try {
			...
			for(int i=0;i<classes.getLength();i++){
				...
				if(className==null || className.length()==0){
					throw new XmlLoadException("'name' attribute is required.");
				}
	...
	private static AnnotationInfo[] getAnnotationInfo(NodeList annotations) throws XmlLoadException {
	...
	private static Map<String, String> getAttributes(Element annotations) throws XmlLoadException {
