...
public class CellLinkCellConverter extends AbstractCellConverter<CellLink> {
    ...
    @Override
    protected CellLink parseDefaultValue(final String defaultValue, final FieldAdapter adapter,
    ...
    @Override
    protected CellLink parseCell(final Cell evaluatedCell, final String formattedValue, final FieldAdapter adapter,
            final XlsMapperConfig config) throws TypeBindException {
    ...
    @Override
    protected void setupCell(final Cell cell, final Optional<CellLink> cellValue, final FieldAdapter adapter,
            final XlsMapperConfig config) throws TypeBindException {
