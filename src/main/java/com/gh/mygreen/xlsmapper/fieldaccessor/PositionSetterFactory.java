...
/**
 * {@link PositionSetter}のインスタンスを作成する
 * 
 * @since 2.0
 * @author T.TSUCHIE
 *
 */
public class PositionSetterFactory {
    
    private static final Logger log = LoggerFactory.getLogger(PositionSetterFactory.class);
     ...
     */
    public Optional<PositionSetter> create(final Class<?> beanClass, final String fieldName) {
        
        ArgUtils.notNull(beanClass, "beanClass");
        ArgUtils.notEmpty(fieldName, "fieldName");
        
        // フィールド Map positionsの場合
        Optional<PositionSetter> positionSetter = createMapField(beanClass, fieldName);
        if(positionSetter.isPresent()) {
            return positionSetter;
        }
        
        // setter メソッドの場合
        positionSetter = createMethod(beanClass, fieldName);
        if(positionSetter.isPresent()) {
            return positionSetter;
        }
        
        // フィールド + positionの場合
        positionSetter = createField(beanClass, fieldName);
        if(positionSetter.isPresent()) {
            return positionSetter;
        }
     ...
     * @return 位置情報の設定用クラス
     */
    private Optional<PositionSetter> createMapField(final Class<?> beanClass, final String fieldName) {
            ...
            return Optional.of(new PositionSetter() {
                ...
                public void set(final Object beanObj, final CellPosition position) {
                    ...
                    try {
                        ...
                        positionsMapObj.put(fieldName, position);
            ...
            return Optional.of(new PositionSetter() {
                ...
                public void set(final Object beanObj, final CellPosition position) {
                    ...
                    try {
                        ...
                        positionsMapObj.put(fieldName, position.toPoint());
     ...
     * @return 位置情報の設定用クラス
     */
    private Optional<PositionSetter> createMethod(final Class<?> beanClass, final String fieldName) {
        ...
        try {
            ...
            return Optional.of(new PositionSetter() {
                ...
                public void set(final Object beanObj, final CellPosition position) {
                    ...
                    try {
                        method.invoke(beanObj, position);
        ...
        try {
            final Method method = beanClass.getDeclaredMethod(positionMethodName, Point.class);
            method.setAccessible(true);
        ...
        try {
            final Method method = beanClass.getDeclaredMethod(positionMethodName, org.apache.poi.ss.util.CellAddress.class);
            method.setAccessible(true);
        ...
        try {
            final Method method = beanClass.getDeclaredMethod(positionMethodName, Integer.TYPE, Integer.TYPE);
            method.setAccessible(true);
            ...
            return Optional.of(new PositionSetter() {
                ...
                public void set(final Object beanObj, final CellPosition position) {
                    ...
                    try {
                        method.invoke(beanObj, position.getColumn(), position.getRow());
     ...
     * @return 位置情報の設定用クラス
     */
    private Optional<PositionSetter> createField(final Class<?> beanClass, final String fieldName) {
        ...
        if(positionField.getType().equals(CellPosition.class)) {
            ...
            return Optional.of(new PositionSetter() {
                ...
                public void set(final Object beanObj, final CellPosition position) {
                    ...
                    try {
                        positionField.set(beanObj, position);
                    } catch (IllegalArgumentException | IllegalAccessException e) {
                        throw new RuntimeException("fail access position field.", e);
                    }
                }
            ...
            return Optional.of(new PositionSetter() {
                ...
                public void set(final Object beanObj, final CellPosition position) {
                    ...
                    try {
                        positionField.set(beanObj, position.toPoint());
                    } catch (IllegalArgumentException | IllegalAccessException e) {
                        throw new RuntimeException("fail access position field.", e);
                    }
                }
