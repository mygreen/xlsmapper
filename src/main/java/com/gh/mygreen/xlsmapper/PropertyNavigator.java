...
import com.gh.mygreen.xlsmapper.PropertyPath.Token;
...
public class PropertyNavigator {
    ...
    public static Object get(final Object obj, final String property) {
        return new PropertyNavigator().getProperty(obj, property);
    }
    ...
    private Object accessPropertyByKey(final Object targetObj, final Token.Key token) {
        ...
        if(List.class.isAssignableFrom(targetClass)) {
            ...
            if((index < 0 || index >= array.length) && ignoreNotFoundKey) {
                return null;
            }
            return array[index];
