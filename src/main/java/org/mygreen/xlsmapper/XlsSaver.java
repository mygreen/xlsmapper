...
import org.mygreen.xlsmapper.fieldprocessor.SavingFieldProcessor;
import org.mygreen.xlsmapper.validation.SheetBindingErrors;
import org.mygreen.xlsmapper.xml.AnnotationReader;
import org.mygreen.xlsmapper.xml.XMLInfo;
import org.mygreen.xlsmapper.xml.XMLLoader;
...
public class XlsSaver {
    ...
    private org.apache.poi.ss.usermodel.Sheet[] findSheet(final Workbook book, final XlsSheet sheetAnno,
            final Object obj, final SavingWorkObject work) throws SheetNotFoundException, AnnotationInvalidException {
     ...
     * @throws XlsMapperException
     */
    private FieldAdaptor getSheetNameField(final Object obj, SavingWorkObject work) throws XlsMapperException {
